...
distinct from this service's own inbound ``SCAMINTERDICT_S2S_TOKEN``.
...
_SERVICE_ACTOR = "app-fraud-interdiction"
...
class CloudReviewRouter:
    ...
    def route(self, result: InterdictionAssessment, *, maker: str, tenant: str = "") -> str:

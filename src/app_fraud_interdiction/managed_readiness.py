...
INCOMPLETE_MANAGED_OPERATIONS: tuple[str, ...] = (
    "conversation_channel.CcaiConversationChannel.fetch",
    "features.VertexFeatureStore.features_for",
    "payment_stream.BigQueryPaymentStream.poll",
    "warning_generator.VertexWarningGenerator.draft",
)

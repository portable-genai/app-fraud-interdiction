...
lockfile is installed, the gate sets ``SCAMINTERDICT_REQUIRE_IAP_MATRIX=1`` and
...
from app_fraud_interdiction.config import Settings
...
_REQUIRE_ENV = "SCAMINTERDICT_REQUIRE_IAP_MATRIX"

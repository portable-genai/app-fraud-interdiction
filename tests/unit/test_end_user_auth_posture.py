...
read
    ...
    bind_profile == local AND profile chosen AND SCAMINTERDICT_S2S_TOKEN unset
...
approver's groups and tenant, and ``/v1/interdict`` with a real escalated decision written to the
review outbox.
...
from app_fraud_interdiction.adapters.local.identity import (
    LocalIdentityAdapter,
)
from app_fraud_interdiction.adapters.onprem.identity import (

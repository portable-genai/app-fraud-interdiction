...
def test_the_demo_data_is_obviously_fictional() -> None:
    ...
    for case in cases:
        # Opaque, invented references: no real party names on the payment events.
        assert case.payer_ref.startswith("payer-"), case.payer_ref
    blob = " ".join(case.memo for case in cases) + " " + demo.ACTOR

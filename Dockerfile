# Scam and APP Interdiction (G3) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    SCAMINTERDICT_PROFILE=gcp \
    SCAMINTERDICT_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m app_fraud_interdiction.managed_readiness && exec uvicorn app_fraud_interdiction.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
